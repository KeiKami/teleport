...
- [Azure Active Directory (AD)](ssh-azuread.mdx)
- [Active Directory (ADFS)](ssh-adfs.mdx)
- [Google Workspace](ssh-google-workspace.mdx)
- [GitLab](gitlab.mdx)
...
same as the first part of their email address - the 'local' part. For example, `dave.smith@acme.com` might log in with the username `dave.smith`. Teleport provides adds an easy way to
